import {AsyncValidatorFn, ValidatorFn} from "../models/validator.model";
import {AbstractControl as AbstractControl} from "../models/abstract-control.class";
import {AbstractControlOptions as AbstractControlOptions} from "../models/abstract-control-options.interface";
import {FormArray, UntypedFormArray} from "../models/form-array.class";
import {
    FormControlOptions,
    UntypedFormControl,
    FormControlState,
    FormControl
} from "../models/form-control.class";
import {
    FormGroup,
    FormRecord,
    UntypedFormGroup
} from "../models/form-group.class";
...
export class FormBuilder {
    ...
    control<T>(
        ...
        return new FormControl<T>(formState, {
            ...newOptions,
            nonNullable: true
        });
    }
