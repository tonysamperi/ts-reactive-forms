...
//
import {AsyncValidatorFn, ValidationErrors, ValidatorFn} from "./validator.model";
import {FormHooks} from "./form-hooks.type";
import {AbstractControlOptions} from "./abstract-control-options.interface";
import {FNS} from "../utils/form-validators.class";
import {FormGroup} from "./form-group.class";
import {FormArray} from "./form-array.class";

export enum FormControlStates {
    VALID = "VALID",
    INVALID = "INVALID",
    PENDING = "PENDING",
    DISABLED = "DISABLED"
...
export abstract class AbstractControl<TValue = any, TRawValue extends TValue = TValue> {
    ...
    get disabled(): boolean {
        return this.status === FormControlStates.DISABLED;
    }
     ...
     */
    get invalid(): boolean {
        return this.status === FormControlStates.INVALID;
    }
     ...
     */
    get pending(): boolean {
        return this.status === FormControlStates.PENDING;
    }
    ...
    get status(): FormControlStates {
        return this._status;
    }

    get statusChanges(): Observable<FormControlStates> {
     ...
     */
    get valid(): boolean {
        return this.status === FormControlStates.VALID;
    }
    ...
    protected _status: FormControlStates = FormControlStates.PENDING;
    protected _statusChanges$: Subject<FormControlStates> = new Subject<FormControlStates>();
    ...
    /** @internal */
    // eslint-disable-next-line @typescript-eslint/naming-convention
    _find(_name_: string | number): AbstractControl | null {
        return null;
    }
    ...
    disable(opts: { onlySelf?: boolean, emitEvent?: boolean } = {}): void {
        ...
        this._status = FormControlStates.DISABLED;
        this._errors = null;
    ...
    enable(opts: { onlySelf?: boolean, emitEvent?: boolean } = {}): void {
        ...
        this._status = FormControlStates.VALID;
        this._forEachChild((control: AbstractControl) => {
            control.enable({
                               ...opts,
                               onlySelf: true
    ...
    markAsPending(opts: { onlySelf?: boolean, emitEvent?: boolean } = {}): void {
        this._status = FormControlStates.PENDING;
    ...
    updateValueAndValidity(opts: { onlySelf?: boolean, emitEvent?: boolean } = {}): void {
        ...
        if (this.enabled) {
            ...
            if (this.status === FormControlStates.VALID || this.status === FormControlStates.PENDING) {
    ...
    /** @internal */
    protected _anyControlsHaveStatus(status: FormControlStates): boolean {
    ...
    protected _calculateStatus(): FormControlStates {
        if (this._allControlsDisabled()) {
            return FormControlStates.DISABLED;
        }
        if (this._errors) {
            return FormControlStates.INVALID;
        }
        if (this._hasOwnPendingAsyncValidator || this._anyControlsHaveStatus(FormControlStates.PENDING)) {
            return FormControlStates.PENDING;
        }
        if (this._anyControlsHaveStatus(FormControlStates.INVALID)) {
            return FormControlStates.INVALID;
        }
        return FormControlStates.VALID;
    }
    ...
    protected _setInitialStatus(): void {
        this._status = this._allControlsDisabled() ? FormControlStates.DISABLED : FormControlStates.VALID;
    }
