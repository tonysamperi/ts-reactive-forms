...
import {
    ...
    ɵTypedOrUntyped, ɵRawValue, ɵValue
} from "./abstract-control.class";
import {FNS} from "../utils/form-validators.class";
import {AbstractControlOptions as AbstractControlOptions} from "./abstract-control-options.interface";
 ...
 * @publicApi
 */
export class FormGroup<TControl extends { [K in keyof TControl]: AbstractControl<any> } = any> extends AbstractControl<
 ...
 * @publicApi
 */
export class FormRecord<TControl extends AbstractControl = AbstractControl> extends FormGroup<{ [key: string]: TControl }> {
}
